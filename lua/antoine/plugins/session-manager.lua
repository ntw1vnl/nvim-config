return {
	...
	config = function()
		...
		keymap.set("n", "<leader>wl", "<cmd>SessionManager load_session<CR>", { desc = "Load session" })
		keymap.set("n", "<leader>ws", "<cmd>SessionManager save_current_session<CR>", { desc = "Save current session" })
		keymap.set("n", "<leader>wd", "<cmd>SessionManager delete_session<CR>", { desc = "Delete session" })
	end,
}
